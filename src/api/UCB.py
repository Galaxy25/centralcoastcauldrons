...
def update_ucb(connection, potion_id: int):
...
def increment_shown(connection, potion_id: int):
    connection.execute(
        sqlalchemy.text(
            """
            UPDATE ucb
...
def increment_bought(connection, potion_id: int):
    connection.execute(
        sqlalchemy.text(
            """
            UPDATE ucb
